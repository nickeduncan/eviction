...
RSpec.describe "eviction_cases/new", type: :view do
  before(:each) do
    assign(:eviction_case, EvictionCase.new(
  ...
  it "renders new eviction_case form" do
    render

    assert_select "form[action=?][method=?]", eviction_cases_path, "post" do
